...
This page only shows their default style. The theme offers style variations for many of these elements. The notes on this page are not part of Hugo’s usual Markdown options and are generated by the theme’s shortcode [`mnote`](https://perplex.desider.at/doc/improved/shortcode/mnote).
...
{{< mnote >}}
This theme supports safe Markdown &rightarrow; `unsafe: false`. The elements here are generated by `replaceRE …` of [replacement codes](https://perplex.desider.at/doc/improved/replace).
{{< /mnote >}}
