...
{{< mnote >}}
This theme supports safe Markdown &rightarrow; `unsafe: false`. The elements here are partially generated by `replaceRE …` of [replacement codes](https://perplex.desider.at/doc/enhancing/replace).
{{< /mnote >}}
