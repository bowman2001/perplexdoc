...
On larger screens (view-port &ge; {$600px}) the [responsive design][rd] is combined with [view-port-sized design][ptres]—a.k.a. fluid typography[^2]. Hence, the layout is consistent between breakpoints. When the font-size would get to large on wide screens, it gets fixed and the layout is centered.
