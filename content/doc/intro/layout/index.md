...
On larger screens (view-port &ge; {$592px}) the [responsive design][rd] is combined with [view-port sized design][ptres]—a.k.a. fluid typography[^2]. This allows to stick to a fixed layout with coherent columns between breakpoints. When a reasonable large font size has been reached on wide screens, the layout doesn’t adapt anymore and just gets centered.
